...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        {/* oxlint-disable-next-line shadcn/no-arbitrary-values -- offsets the arrow by half its own size plus a fixed nudge to sit flush against the tooltip edge; not expressible as a fixed scale value */}
