...
function BuilderCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group relative flex min-h-72 flex-col rounded-xl border bg-background p-5 shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-accent-border hover:shadow-lg",
