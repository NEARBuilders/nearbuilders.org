...
export const Route = createFileRoute("/_layout/_authenticated/_dashboard/profile")({
  head: () => ({
    meta: [
      { title: "Profile | app" },
      { name: "description", content: "Manage your builder profile." },
    ],
  }),
  component: Profile,
});
          ...
          <div className="flex flex-col items-center justify-center gap-5 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
                Link a NEAR account to access your builder profile, projects, and workspace.
              </p>
            </div>
    ...
    <DashboardPageFrame>
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-1">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
                Keep the work you are shipping visible from one place.
              </p>
            </div>
        ...
        <aside className="space-y-4">
          <ProjectsSummaryCard projectCount={projectCount} isLoading={projectsLoading} />
          <BuilderProfileCard
...
function SkillsHubCard() {
  return (
    <a
      ...
      className="group relative flex min-h-[132px] flex-col justify-between rounded-xl border border-border bg-card p-5 transition-colors hover:border-border-strong hover:bg-secondary/40"
    >
      <ExternalLink
        size={12}
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="rounded-full border border-border bg-secondary px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-muted-foreground">
          soon
        </span>
      </div>
      <div>
        <p className="text-sm font-semibold text-foreground">Skills hub</p>
        <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
          Track builder skills and credentials when the hub opens.
        </p>
        <p className="mt-2 font-mono text-[11px] text-muted-foreground/70">hub.ironclaw.com</p>
      </div>
    </a>
  );
}
    ...
    >
      <div className="flex min-w-0 items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
            View every project attached to this account.
          </p>
        </div>
      </div>
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div className="min-w-0 space-y-2">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">Builder profile</h1>
          <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
            Review your builder profile, application status, and recent work.
          </p>
        </div>
      </div>
      <Button
