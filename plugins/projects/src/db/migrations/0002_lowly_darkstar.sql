ALTER TABLE "project_apps" ADD COLUMN IF NOT EXISTS "domain" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "project_apps" DROP COLUMN IF EXISTS "gateway_id";--> statement-breakpoint
